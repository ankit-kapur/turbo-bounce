...
def game():
    ...
    try:
        Bird.image.append(pygame.image.load("/data/babytux.png"))
        Bird.image.append(pygame.image.load("/data/babytux_neg.png"))
    except:
    ...
    try:
        cry = pygame.mixer.Sound('data/claws.ogg')  #load sound
    except:
